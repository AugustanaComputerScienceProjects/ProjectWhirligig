...
#begin building the multilayer convolutional network

#initialize weights with a slightly positive initial bias
...
#create our first convolutional layer
...
#create our second convolutional layer
...
#train and evaluate (WARNING: does 20,000 training iterations)
#should produce an accuracy of roughly 99.2%
